  ...
  return (
    <div className="flex flex-col h-full bg-gradient-to-b from-blue-50/50 to-white/50 backdrop-blur-sm">
      ...
      <div className="flex flex-col h-full max-w-6xl mx-auto w-full px-4 md:px-6 py-4 pb-36 md:pb-40">
        ...
        {/* Contenedor principal de controles flotantes */}
        <div className="fixed bottom-0 left-0 right-0 flex flex-col justify-end items-center pb-8 md:pb-10">
          ...
          <div className="relative flex items-center justify-center w-full max-w-md px-4">
            {/* Contenedor del botón PTT y descarga */}
            <div className="relative flex items-center gap-4 md:gap-6">
              ...
              <motion.button
                ...
                whileTap={{ scale: 0.95 }}
                className="relative p-3 bg-gradient-to-br from-blue-500 to-blue-600 text-white rounded-full shadow-lg hover:from-blue-600 hover:to-blue-700 transition-all duration-300 backdrop-blur-sm border-2 border-blue-400/30 hover:shadow-xl hover:shadow-blue-400/20 md:scale-110"
