...
export const MODERATION_CATEGORIES = [
  "PEDAGOGICALLY_UNSOUND",
  "OFF_TOPIC_STUDENT",
  "STUDENT_FRUSTRATION_ESCALATION",
  "ACADEMIC_HONESTY_VIOLATION_ATTEMPT",
  "INAPPROPRIATE_STUDENT_CONTENT",
...
export interface AgentConfig {
  ...
  instructions: string;
  tools: Tool[];
  voice?: string; // OpenAI TTS voice to use (alloy, echo, fable, onyx, nova, shimmer)
  toolLogic?: Record<
    string,
